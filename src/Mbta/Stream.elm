port module Mbta.Stream exposing
    ( ApiData
    , ApiResult(..)
    , Error(..)
    , Msg
...
eventDataDecoder eventName =
    case eventName of
        "reset" ->
            Decode.map Reset (Decode.list Mbta.Decoders.resourceDecoder)

        "add" ->
            Decode.map Insert Mbta.Decoders.resourceDecoder

        "update" ->
            Decode.map Insert Mbta.Decoders.resourceDecoder

        "remove" ->
            Decode.map Remove Mbta.Decoders.resourceIdDecoder
